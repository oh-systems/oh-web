        ...
        {initialLoadComplete && (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-full h-full flex items-center justify-center">
              ...
              {/* Cast Shadows sequence - pre-mount before swap starts, fade in during swap */}
              {castSwapProgress > 0 && laptopSwapProgress < 1 && (
                <div
                  style={{
                    position: "absolute",
                    inset: 0,
                    width: "100vw",
                    height: "100vh",
                    opacity: Math.min(1, castSwapProgress * 2), // Fade in during first half of swap
                    pointerEvents: castSwapProgress < 0.5 ? "none" : "auto",
                  }}
                >
                  <CastShadowsSequence
