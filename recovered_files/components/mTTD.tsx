          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-full h-full flex items-center justify-center">
              ...
              <div
                style={{
                  visibility:
                    castSwapProgress > 0.1 || initialScrollProgress <= 0.01
                      ? "hidden"
                      : "visible",
                  opacity:
                    castSwapProgress > 0.1 || initialScrollProgress <= 0.01
              ...
              <div
                style={{
                  visibility:
                    castSwapProgress < 0.1 || laptopSwapProgress > 0.1
                      ? "hidden"
                      : "visible",
                  opacity:
                    castSwapProgress < 0.1 || laptopSwapProgress > 0.1
              ...
              >
                <CastShadowsSequence
                  ...
                  priority={castSwapProgress > 0.05} // Only prioritize when starting to show
                />
              </div>
              ...
              <div
                style={{
                  visibility: laptopSwapProgress < 0.1 ? "hidden" : "visible",
                  opacity: laptopSwapProgress < 0.1 ? 0 : 1,
                  display: "flex",
                  position: "absolute",
                  inset: 0, // Full-screen positioning
                  width: "100vw",
                  ...
                  pointerEvents: laptopSwapProgress < 0.1 ? "none" : "auto",
                }}
              >
                <ThirdLaptopSequence
                  ...
                  priority={laptopSwapProgress > 0.05} // Only prioritize when starting to show
                />
              </div>
            </div>
