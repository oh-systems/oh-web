        ...
        {initialLoadComplete && (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-full h-full flex items-center justify-center">
              ...
              {/* Cast Shadows sequence - mount early for preloading, show when in range */}
              {animationProgress >= 0.2 && animationProgress <= 0.9 && (
                <div
                  style={{
                    position: "absolute",
                    inset: 0,
                    width: "100vw",
                    height: "100vh",
                    opacity: animationProgress >= 0.286 ? 1 : 0, // Hidden until transition point
                    pointerEvents: animationProgress >= 0.286 ? "auto" : "none",
                    visibility: "visible", // Always mounted for preloading
