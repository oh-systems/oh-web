  ...
  useLayoutEffect(() => {
    ...
    const updateAnimationProgress = () => {
      ...
      if (isAutoPlaying && !isManualNavigationRef.current) {
        ...
        const autoScrollProgress = (autoPlayTime / 150) * maxScrollRange; // 150 seconds total animation for slower, smoother transitions
      ...
      if (manualProgressRef.current !== null) {
        ...
        autoPlayTime = manualProgressRef.current * 150;
    ...
    const handleWheel = (e: WheelEvent) => {
      ...
      autoPlayTime = (scrollAccumulator / (window.innerHeight * 3)) * 150;
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      switch (e.key) {
        ...
        case "End":
          ...
          autoPlayTime = 150; // Full progression time
          break;
        default:
          return;
      }
